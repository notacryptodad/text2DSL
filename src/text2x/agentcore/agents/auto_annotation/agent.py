...
class AutoAnnotationAgent(AgentCoreBaseAgent):
    """Auto-annotation agent for schema understanding and annotation.
    ...
    def __init__(
        ...
        logger.info(f"AutoAnnotationAgent '{name}' initialized with {len(self.tools)} tools")
    ...
    async def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
                ...
                if json_start >= 0 and json_end > json_start:
                    ...
                    if "tool" in tool_request and tool_request["tool"] in self.tools:
                        ...
                        tool_result_message = (
                            ...
                            f"Please provide a summary and next steps for the user."
                        )
        ...
        logger.info(
            f"Processed annotation request in {duration_ms:.2f}ms, "
