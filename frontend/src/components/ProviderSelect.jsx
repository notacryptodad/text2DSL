    ...
    <div className="space-y-2">
      {providers.map((provider) => (
        <button
          ...
          className={`w-full flex items-center justify-between p-3 rounded-lg border-2 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:border-transparent ${
            disabled
